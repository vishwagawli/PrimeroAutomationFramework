...
public class Cases_acceptorRejectTransferCase extends TestBase {
	LoginPage loginPage;
	HomePage homePage;
	CasesPage casespage;
	
	String sheetName = "RejectTransferCase";
	
	public Cases_acceptorRejectTransferCase() {
		super();
	}
	...
	public void remoteReferCase(String text,String agency,String recipt, String Notes,String comment) throws Exception{
