...
public class Add_User extends TestBase {
	LoginPage loginPage;
	HomePage homePage;
	//CasesPage casespage;
	...
	public void createUser(String fullname_txt,String username_txt, String pwd_txt, String confirmpwd_txt, 
			String userrole, String usrgrp, String email_txt,String agency_txt, String locatn) throws Exception{
		
		settingpage.createNewUser(fullname_txt, username_txt, pwd_txt, confirmpwd_txt, userrole, usrgrp, email_txt, agency_txt,locatn);
