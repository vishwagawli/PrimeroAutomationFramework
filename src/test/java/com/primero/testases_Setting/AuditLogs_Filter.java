...
public class AuditLogs_Filter extends TestBase {
	LoginPage loginPage;
	HomePage homePage;
	//CasesPage casespage;
	...
	@Test(priority=1)
	public void AuditFilter() throws Exception{
		//TestUtil.getNameFromTable(text);
		settingpage.goToAuditlogab();
		settingpage.filterlogsbyDate();
