...
public class Add_Form extends TestBase {
	LoginPage loginPage;
	HomePage homePage;
	//CasesPage casespage;
	SettingPage settingpage;
	
	String sheetName = "forms_setting";
	...
	//@Test(priority=1)
	public void addForm(String name, String desc, String module, String recordType, String formgroup)throws Exception{
		
		settingpage.goToFormTab();
		settingpage.addForms(name,desc,module,recordType,formgroup);
	}
