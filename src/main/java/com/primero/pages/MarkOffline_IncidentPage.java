...
public class MarkOffline_IncidentPage extends TestBase{
	...
	public MarkOffline_IncidentPage()
		{
	...
	/*	cp_identification_violence.clear();
		...
		*/
		...
		Assert.assertEquals(inci_toastermsg, "You are currently offline. Your changes will be submitted when you are back online.","Toaster message doesnt matched.");
		
		}
	public void mo_edit(String violence, String area, String location, String timeofday, String violencetype ,String nationality, String age, String nationalId) throws InterruptedException
	{
		Thread.sleep(8000);
		newBtn.click();
		Thread.sleep(1000);
